# -*- coding: utf-8 -*-
"""
Created on Wed Sep  8 15:42:07 2021
...
import os
import numpy as np
from customized_Image_Loader import imageLoader
...
####################################################
train_img_dir = "BraTS2020_TrainingData/input_data_128/train_2/images/"
train_mask_dir = "BraTS2020_TrainingData/input_data_128/train_2/masks/"
...
train_mask_list = sorted(glob.glob('BraTS2020_TrainingData/input_data_128/train_2/masks/*.npy'))
...
val_img_dir = "BraTS2020_TrainingData/input_data_128/val_2/images/"
val_mask_dir = "BraTS2020_TrainingData/input_data_128/val_2/masks/"
...
test_img = np.load("BraTS2020_TrainingData/input_data_128/val_2/images/image_"+str(img_num)+".npy")

test_mask = np.load("BraTS2020_TrainingData/input_data_128/val_2/masks/mask_"+str(img_num)+".npy")
